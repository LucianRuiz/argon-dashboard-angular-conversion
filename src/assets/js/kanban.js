// jkanban init for Angular - Now handled by Angular component
// This file is kept for reference but initialization is done in kanban.ts
...
(function() {
    ...
    setTimeout(function() {
        if (document.getElementById("myKanban")) {
            // Make KanbanTest available globally
    ...
    }, 2000); // Wait 2 seconds for Angular to finish rendering
})();
*/